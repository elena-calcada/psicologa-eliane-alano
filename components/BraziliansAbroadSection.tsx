        ...
        <div className="relative overflow-hidden w-full h-full flex items-center justify-center">
          ...
          <div className="container">
            ...
            <div className="w-full flex flex-col gap-8 items-center justify-center xl:flex-row-reverse xl:gap-16">
              ...
              >
                <p className="p">
                  Muitas pessoas que sairam  de seu país de origem vivem um dos maiores desafios que pode enfrentar um ser humano. Além do stress por ter que se adaptar a condições de vida estranhas, língua, costumes e clima, esta tensão pode ter  como agravante a saudade da terra natal e do que é conhecido.  Esta saudade vem da segurança que nos proporciona o que é conhecido, a segurança de conhecer o terreno onde se está pisando.  O apoio psicoterápico com um profissional que fale sua língua nativa,  pode ser fundamental para que a adaptação ao país estrangeiro possa ser mais tranquila.
                </p>
                <p className="p">
